...
//                    new LoginForm(theme).show();
                ...
                try {
                    ...
                    Mailer.sendMail(email.getText(),randomNum);
                    new CodeVerificationForm(randomNum).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private class CodeVerificationForm extends Form{
        ...
        String random_num;
        Button resend;
        public CodeVerificationForm(int randomNum) {
            super(new BorderLayout(BorderLayout.CENTER_BEHAVIOR_CENTER_ABSOLUTE));
            setUIID("LoginForm");
        ...
        private void addActions2() {
            continue_button.addActionListener(evt -> {
                if (verification_code.getText().equals(""))
                    ...
                    new ContinueRegistrationForm().show();
